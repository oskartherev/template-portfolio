...
/*          about section tabs          */
/* ==================================== */
// inmediatly invoked funtion expression - using arrow function
(() => {
  const aboutSection = document.querySelector(".about-section"),
    tabsContainer = document.querySelector(".about-tabs");

  tabsContainer.addEventListener("click", () => {
    // if event.tarjet constains 'tab-item' class and not constains 'active' class
    if (
...
(() => {
  ...
  filterContainer.addEventListener("click", (event) => {
    if (
      ...
      // desactuvate existing active 'filter-item
      filterContainer
        .querySelector(".active")
        .classList.remove("outer-shadow", "active");
  ...
  function popupSlideshow() {
    ...
    // avtivate loader until the popupImg loaded
  ...
  function popupDetails() {
    // if portfolio-item-details bit exusts
    ...
    const categoty = portfolioItems[itemIndex].getAttribute("data-category");
    // set the project category
    popup.querySelector(".pp-project-category").innerHTML = categoty
      .split("-")
      .join(" ");
  }
